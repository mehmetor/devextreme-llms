[**DevExtreme React Toolbar API v26.1.0**](../../../../README.md)

***

[DevExtreme React Toolbar API](../../../../globals.md) / [ToolbarTypes](../README.md) / dxToolbarOptions

# ~~Interface: dxToolbarOptions\<TItem, TKey\>~~

Defined in: devextreme/artifacts/npm/devextreme/ui/toolbar.d.ts:117
...
- `CollectionWidgetOptions`\<`dxToolbar`\<`TItem`, `TKey`\>, `TItem`, `TKey`\>
...
Defined in: devextreme/artifacts/npm/devextreme/ui/toolbar.d.ts:127
...
Defined in: devextreme/artifacts/npm/devextreme/ui/toolbar.d.ts:134
...
> `optional` **menuItemTemplate**: `template` \| (`itemData`, `itemIndex`, `itemElement`) => `string` \| `Element`

Defined in: devextreme/artifacts/npm/devextreme/ui/toolbar.d.ts:148
...
Defined in: devextreme/artifacts/npm/devextreme/ui/toolbar.d.ts:140
...
`EventInfo`\<`dxToolbar`\<`TItem`, `TKey`\>\>
...
`NativeEventInfo`\<`dxToolbar`\<`TItem`, `TKey`\>, `PointerInteractionEvent`\> & `ItemInfo`\<`TItem`\>
...
`EventInfo`\<`dxToolbar`\<`TItem`, `TKey`\>\> & `ItemInfo`\<`TItem`\>
...
`OptionChangedEventInfo`\<`dxToolbar`\<`TItem`, `TKey`\>\>
...
`EventInfo`\<`dxToolbar`\<`TItem`, `TKey`\>\> & `SelectionChangeInfo`\<`TItem`\>
...
`SelectionChangingEventBase`\<`dxToolbar`\<`TItem`, `TKey`\>\>
